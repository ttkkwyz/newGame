...
export function showEffect(target: StatusWindow, card: Card){
...
export function showExplosionEffect(target: StatusWindow) {
...
export function showHealSparkleEffect(target: StatusWindow) {
...
export function showRifleEffect(target: StatusWindow) {
